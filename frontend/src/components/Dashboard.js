...
const Dashboard = ({
  ...
  useEffect(() => {
    ...
    fetch("https://itams-app-production.up.railway.app/api/inventory", { headers })
      .then((r) => r.json())
      .then((data) => {
    ...
    fetch("https://itams-app-production.up.railway.app/api/asset-requests?status=Pending", { headers })
      .then((r) => r.json())
      .then((data) => {
