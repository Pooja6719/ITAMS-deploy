...
const validateEmployeeId = (id) => {
  ...
  if (date > today) {
    return {
      isValid: false,
      message: "Future employee IDs are not allowed",
    };
  }
...
const validatePurpose = (purpose) => {
  ...
  if (purpose !== purpose.trimStart()) {
    return {
      isValid: false,
      message: "Purpose should not start with spaces",
    };
  }
  ...
  if (purpose !== purpose.trimEnd()) {
    return {
      isValid: false,
      message: "Purpose should not end with spaces",
    };
  }
  ...
  if (!/^[A-Za-z\s]+$/.test(purpose)) {
    return {
      isValid: false,
      message: "Purpose should contain letters and spaces only",
    };
  }
...
const validateRequiredDate = (dateValue) => {
  ...
  if (selectedDate < today) {
    return {
      isValid: false,
      message: "Required Date cannot be a past date",
    };
  }
    ...
    const loadRequests = async () => {
      try {
        ...
        const response = await fetch(
          "http://itams-app-production.up.railway.app/api/asset-requests",
          {
            headers: {
    ...
    <div className="ar-page">
      ...
      <div className="ar-body">
        ...
        <div className="ar-main-grid">
          ...
          <div className="ar-left-column">

            <div className="ar-card ar-request-card">
          ...
          <div className="ar-right-column">

            {/* =================================================
                SEARCH EMPLOYEE
            ================================================= */}

            <div className="ar-card ar-search-card">
            ...
            <div className="ar-card ar-history-card">
